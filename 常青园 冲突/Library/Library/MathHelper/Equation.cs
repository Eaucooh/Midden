namespace Library.MathHelper
{
    public class Equation
    {
        ...
        public static double[] SolveEquation(double a1, double b1, double c1, double a2, double b2, double c2)
        {
        ...
        /// <returns>结果 - x，y - 组成的数组</returns>
        public static double[] SolveEquation(double a1, double b1, double c1, double d1, double a2, double b2, double c2, double d2, double a3, double b3, double c3, double d3)
        {
            ...
            double[] y_z = SolveEquation(na1, nb1, nc1, na2, nb2, nc2);
            y = y_z[0]; z = y_z[1];
            x = (d1 - b1 * y - c1 * z) / a1;
        ...
        public static double[] SolveEquation(double a1, double b1, double c1, double d1, double e1, double a2, double b2, double c2, double d2, double e2, double a3, double b3, double c3, double d3, double e3, double a4, double b4, double c4, double d4, double e4)
        {
            ...
            double[] y_z_m = SolveEquation(na1, nb1, nc1, nd1, na2, nb2, nc2, nd2, na3, nb3, nc3, nd3);
