...
namespace Zoomer
{
    ...
    public partial class Frm_Main : Form, IContract
    {
        public Frm_Main()
        {
            InitializeComponent();
        ...
        {
            RegisterHotKey(Handle, 81, KeyModifiers.Alt, Keys.Escape);
            ...
            ColorSign.BackColor = cl;
            if (mx <= this.Width - 22 && my <= this.Height)
            {
        ...
        public string GetName() => "Zoomer";

        public string GetVersion() => "Beta";

        public string GetPublisher() => "Catrol";

        public string GetDescribe_Simple() => "放大镜";

        public string GetDescribe_Complex() => "实现鼠标所在点的放大显示";

        public string GetHelpLink() => "http://works.catrol.cn/";

        public string GetHostLink() => "http://www.catrol.cn/";

        public Languages GetLang() => Languages.general;

        public System.Windows.Media.Imaging.BitmapImage GetIcon() => new System.Windows.Media.Imaging.BitmapImage(new Uri($"{workBase}\\icon.ico", UriKind.Absolute));

        public System.Windows.Window GetWindow() => new System.Windows.Window();

        public void Start() => Visible = !Visible;
        ...
        public string GetFileName() => "Zoomer.dll";

        public System.Windows.Controls.UserControl GetQuickView() => null;

        public Tags GetTag() => Tags.Design;

        public void SetWorkBase(string path) => workBase = path;
