...
namespace Library.MathHelper
{
    public class Basic
    {
        ...
        /// 按指定位数补齐数字
        /// </summary>
        /// <param name="num">源数字</param>
        /// <param name="length">补齐后长度</param>
        /// <param name="symbol">占位符号</param>
        /// <returns>补齐后文本</returns>
        public static string CoverPosition(int num, int length, char symbol)
        {
            ...
            {
                throw new Exception("num.Length can't be longer than length.");
            }
        }
    }
}
