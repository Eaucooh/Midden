<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookallstudent.aspx.cs" Inherits="lookallstudent" %>
...
<form id="Form1" runat="server" style=" margin-top:20px;   font-size:4;  font-family:黑体;">
    ...
    <tr ><td  class="style1">
        <font size="5" color="red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 学生信息表<br />
           ...
           >
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="语文成绩" DataField="YW_chengji" >
                <HeaderStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField HeaderText="数学成绩" DataField="SX_chengji" >
                <HeaderStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField HeaderText="英语成绩" DataField="YY_chengji" >
                <HeaderStyle HorizontalAlign="Center" />
                </asp:BoundField>
            </Columns>
